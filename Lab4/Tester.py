...
class Test_model(VAE_Model):
    ...
    def val_one_step(self, img, label, idx=0):
        ...
        prev_frame = img[0]  # shape: (1, 3, 32, 64)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_root',     type=str, default="test_results",  help="The path to save your data")
    ...
    parser.add_argument('--ckpt_path',     type=str,    default="checkpoints/epoch=117.ckpt",help="The path of your checkpoints")   
